...
function App() {
    ...
    return (
        ...
        <div className="button-container">
            ...
            <button type="button" className="heart-health-button">
    ...
    <div className="container">
        ...
        <div onClick={() => startstop()}>
            <div id="thumb"></div>
            <video ref={videoRef} className={`canvas ${isCameraOn ? 'cameraOnAnimation' : 'cameraOffAnimation'}`} style={{display: isCameraOn ? 'block' : 'none'}}></video>
            {isCameraOn ? <img src={cameraGif} alt="Camera Loading" className="canvas1"/> : <div className="canvas2" style={{backgroundColor:'black'}}/> }
            <canvas className={`canvas ${isCameraOn ? 'cameraOnAnimation' : 'cameraOffAnimation'}`} ref={canvasRef} style={{display: isCameraOn ? 'block' : 'none'}}></canvas>
        </div>
        </div>
        </div>
            </IonContent>
